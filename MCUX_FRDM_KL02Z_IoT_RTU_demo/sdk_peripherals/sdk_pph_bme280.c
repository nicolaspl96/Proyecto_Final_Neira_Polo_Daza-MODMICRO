...
status_t bme280ReadData(bme280_data_t *data) {
	...
	if (status == kStatus_Success) {
		...
		data->temperatura = (((uint32_t)(i2c_data[3]) << 12)|((uint32_t)(i2c_data[1]) << 4)|(uint32_t)((i2c_data[2]) >> 4));
		data->humedad = (((uint32_t)(i2c_data[6]) << 8)|(uint32_t)(i2c_data[7]));
		/*data->presion = (uint32_t)(i2c_data[0] << 12);
		data->presion |= (uint32_t)(i2c_data[1] << 4);
		data->presion |= (uint32_t)(i2c_data[2] >> 4);

		data->temperatura = (uint32_t)(i2c_data[3] << 12);
		data->temperatura |= (uint32_t)(i2c_data[4] << 4);
		data->temperatura |= (uint32_t)(i2c_data[5] >> 4);
